        ...
        <div id="board" class="board-form">
            ...
            <div class="bottom">
                ...
                <c:if test="${sessionScope.getOrDefault('authUser',null) != null && sessionScope.get('authUser').id == board.user_id}">
                    <a href="${pageContext.request.contextPath}/board?a=modifyform&id=${board.id}&currentPage=${currentPage}">글수정</a>
                </c:if>
                <c:if test="${sessionScope.get('authUser') != null}">
                    <a href="${pageContext.request.contextPath}/board?a=writeform&id=${board.id}">답글달기</a>
                </c:if>
            </div>
        </div>
    </div>
