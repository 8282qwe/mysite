...
public class BoardDao extends MyConnection {
    ...
    public void updateBoard(BoardVo vo, Long user_id) {
        try (
                Connection conn = getConnection();
                PreparedStatement pstmt = conn.prepareStatement("update board set title = ?,contents=? where user_id = ? and id = ?;");
        ) {
